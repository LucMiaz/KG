...
\end{Soutput}
\begin{figure}
\includegraphics[width=\textwidth]{figures/trainfactor-1} \caption[Ratio of Noisemasked]{Ratio of Noisemasked}\label{fig:trainfactor}
\end{figure}
\end{Schunk}
\newpage
