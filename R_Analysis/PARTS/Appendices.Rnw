...
tabesr <- xtable(bestesr, digits=c(0,3,3,0,0,3,3,0,2),caption='Best thresholds for the fifteen algorithms obtained while considering all the authors together')
print(tabesr,type="latex")
@
<<bestPHFtable, echo=FALSE, results='asis',warning=FALSE>>=
tabphf <- xtable(bestPHF, digits=c(0,3,3,0,0,3,3,0,2),caption='Best thresholds for the fifteen algorithms obtained while considering author PHF')
print(tabphf,type="latex")
@
<<bestluctable, echo=FALSE, results='asis',warning=FALSE>>=
tabluc <- xtable(bestluc, digits=c(0,3,3,0,0,3,3,0,2),caption='Best thresholds for the fifteen algorithms obtained while considering author luc')
print(tabluc,type="latex")
@
<<bestPhCtable, echo=FALSE, results='asis',warning=FALSE>>=
tabphc <- xtable(bestPhC, digits=c(0,3,3,0,0,3,3,0,2),caption='Best thresholds for the fifteen algorithms obtained while considering author PhC')
...
<<bestesrplot, echo=TRUE, fig.cap='ROC plot of the algorithms with their best threshold, tested on author esr. The plot represents the True Positive Rate over the False Positive Rate.', fig.lab='fig:rocesr',warning=FALSE>>=
...
rocplotesr
@
<<bestPHFplot, echo=FALSE, fig.cap='ROC plot of the algorithms with their best threshold, tested on author PHF. The plot represents the True Positive Rate over the False Positive Rate.', fig.lab='fig:rocPHF',warning=FALSE>>=
...
rocplotPHF
@
<<bestlucplot, echo=FALSE, fig.cap='ROC plot of the algorithms with their best threshold, tested on author luc. The plot represents the True Positive Rate over the False Positive Rate.', fig.lab='fig:rocluc',warning=FALSE>>=
...
rocplotluc
@
<<bestPhCplot, echo=FALSE, fig.cap='ROC plot of the algorithms with their best threshold, tested on author PhC. The plot represents the True Positive Rate over the False Positive Rate.', fig.lab='fig:rocPhC', warning=FALSE>>=
